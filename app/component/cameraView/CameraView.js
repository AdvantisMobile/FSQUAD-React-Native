        ...
        if (this.camera) {
            ...
            this.camera.takePictureAsync(options)
                .then((data: any) => {
                    ...
                    this.setState({cameraImagePath:data.uri});
            ...
            return (
                <View style={{flex: 1, padding: 0}}>
                    ...
                    <View style={styles.previewImage}>
                        <Image source={{uri: this.state.cameraImagePath}} style={{height: height-225}}/>
                    </View>
                    <View style={[styles.header,{backgroundColor:'#ffffff'}]}>
                        ...
                        <TouchableOpacity onPress={()=>this.onMarkDone(this.state.images,this.state.cameraImagePath)}>
                            <Text>Done </Text>
                        </TouchableOpacity>
                    </View>
